...
export const FAKE_NEWS_LAWS: FakeNewsLaw[] = [
  // --- NHÓM I: NGÔN NGỮ HỌC & TẬP TÍNH SPAM (L001 - L040) ---
  {
    id: "L001",
  ...
  // --- NHÓM II: TỪ KHÓA BÁO ĐỘNG (L041 - L080) ---
  {
    id: "L041",
  ...
  // --- NHÓM III: MẠO DANH & UY QUYỀN (L081 - L120) ---
  {
    id: "L081",
  ...
  },
  {
    ...
    detail: "Dùng tên VCB, MB, VPB, Techcombank trong ngữ cảnh đe dọa",
    penalty: 35,
    icon: Landmark,
    status: "danger",
    pattern: /Ngân hàng|Vietcombank|VCB|MB Bank|VPBank|Agribank|Techcombank/i
  },
  {
    id: "L084",
  ...
  // --- NHÓM IV: THAO TÚNG TÂM LÝ (L121 - L160) ---
  {
    id: "L121",
    name: "Kích hoạt FOMO",
  ...
  // --- NHÓM V: KỸ THUẬT PHISHING & LINK (L161 - L200) ---
  {
    id: "L161",
  ...
  // --- NHÓM VII: NGÔN NGỮ CHI TIẾT (L009 - L040) ---
  {
    id: "L009",
  ...
  // --- NHÓM VIII: TIN ĐỒN XÃ HỘI (L050 - L080) ---
  {
    id: "L050",
  ...
  // --- NHÓM IX: KỊCH BẢN THAO TÚNG (L130 - L160) ---
  {
    id: "L130",
